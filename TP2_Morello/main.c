    ...
    while(seguir=='s')
    {
        ...
        switch(opcion)
        {
            ...
            case 2: //BORRAR PERSONA.
                ...
                scanf("%s",dniChar);
                //SEGUNDA VALIDACIÓN DE QUE EL DNI SEA SÓLO NUMEROS.
                while(!soloNum(dniChar))
                {
                    printf("\nError: Caracteres invalidos.\nIngrese un DNI correcto: ");
                    scanf("%s",dniChar);
                }
            ...
            case 4: //ORDENA CON UN GRÁFICO POR EDAD.
                ...
                for(j=0;j<I;j++)
                {
                    if(laPersona[j].estado!=0)
                    {
                        ...
                        if((laPersona[j].edadAux>35)&&(laPersona[j].edadAux<100))
                        {
                            cont3++;
                        }
                    }
            ...
            case 5: //MODIFICACIÓN DE DATOS.
                ...
                scanf("%s",dniChar);
                //TERCERA VALIDACIÓN DE QUE EL DNI SEA SÓLO NUMEROS.
                while(!soloNum(dniChar))
                {
                    printf("\nError: Caracteres invalidos.\nIngrese un DNI correcto: ");
                    scanf("%s",dniChar);
